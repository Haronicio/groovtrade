...
INSERT INTO `historique` VALUES (1,_binary '','2023-12-08T20:49:14.550442100','canceled','dth drht 56 fr',2),(2,_binary '\0','2023-12-09T01:55:51.804492600','process','jojo joo 567 fr',1),(3,_binary '\0','2024-01-18T14:35:13.874312200','process','dfdgf fdg fdg fr',2),(4,_binary '\0','2024-01-19T19:01:03.092859100','process','aze azer azer fr',2),(5,_binary '\0','2024-01-19T20:05:53.486335900','process','hfgd fbghv gfdsfg fr',2);
...
INSERT INTO `historique_panier_items` VALUES (1,'',18,1),(1,'',25,1),(2,'',36,3),(3,'',15,1),(4,'',20,1),(5,'',18,1);
...
CREATE TABLE `panier_produits` (
  ...
  `quantite` int NOT NULL,
  `commentaire` varchar(255) DEFAULT NULL,
  `produit_produitid` bigint DEFAULT NULL,
  KEY `FK6ih8q86yjgj8456ywckj9gnom` (`produit_produitid`),
...
INSERT INTO `panier_produits` VALUES (7,36,3,'8 23 et 24',NULL),(11,15,2,'',NULL),(11,18,3,'',NULL),(11,24,3,'',NULL),(11,16,1,'',NULL),(11,44,1,'',NULL),(2,20,1,'',NULL),(2,21,3,'',NULL),(1,49,1,'',NULL),(2,15,2,'',NULL);
...
INSERT INTO `utilisateur` VALUES (1,'c@gmail.com','$2a$10$yzn2KrxOitfMXBWznlqKd.GZ5JDrwk88JLaGYkg5cZMtwAqvZPOD6','ADMIN','myadmin','Pants Shitters.jpg'),(2,'haron@gmail.com','$2a$10$oUHvbLZHHCNs/quyiHVt6.Eiyv/HBhWC4RiKNg7A13sr1zOw.LhVG','ADMIN','haron','0.9.jpg'),(8,'johanned@outlook.fr','$2a$10$SzJe6S2HB/UX37tT/3VWw.ixNMr9EuO89IVJ0CNtOK4.xpVY75KgC','USER','Joelastarrr','Joelastarrr.profile.download20.png'),(7,'loulou@aol.fr','$2a$10$X4LPLAX4xUt16aQ6b7LiGe1S3T2WNotP4E2hvymfkybdN5.vapdPO','USER','loulou','loulou.profile.geneve-lune.jpg'),(9,'HAHA@lol.com','$2a$10$uo9GC5SQgYfJd5ohz0H5CuGlR1zSI3UgNjAwmrrB8dOZolJrYOSWq','USER','HAHA','HAHA.profile.geneve-car.jpg'),(10,'HAHA@lol.com','$2a$10$aJOfxv4eHTdW0Sv7cJGkUunw0ffNjc.JW59q86rMvjt4OKJuWVPO2','USER','HAHA','HAHA.profile.geneve-lun.jpg'),(11,'test@test.test','$2a$10$e.JS3w34fVT0NbSVZEXCS.E2qHx8HYz0WAiQmvFWL9RJSm13Dd8D6','USER','test','test.profile.portrait-6.jpg');
...
-- Dump completed on 2024-01-25  1:10:49
